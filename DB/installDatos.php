...
try {
	DBQuery("INSERT INTO `cloudinator`.`nodos` (`id`, `Subformulario`, `name`, `type`, `posx`, `posy`, `metaname`, `metadata`, `metatype`) VALUES 
...
try {
	DBQuery("INSERT INTO `cloudinator`.`links` (`id`, `Subformulario`, `name`, `source`, `target`) VALUES 
		(NULL, 1, '', 1, 6),
		(NULL, 1, '', 1, 7),
		(NULL, 1, '', 1, 8),
		(NULL, 1, '', 1, 9),
...
echo '<hr>';
echo '<h4>Creando datos en "Subformularios"</h3>';
try {
	DBQuery("INSERT INTO `cloudinator`.`Subformularios` (`id`, `name`, `deleted`, `created`) VALUES 
		...
		");
	echo 'Se han creado datos en "Subformularios" exitosamente';
} catch (Exception $e) {
	echo $e;
}
echo '<hr><br>';
